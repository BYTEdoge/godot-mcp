        ...
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              args: { type: 'array', items: { type: 'string' }, description: 'Optional arguments to pass with the signal' },
            },
        ...
        },
{
        ...
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              args: { type: 'array', items: { type: 'string' }, description: 'Arguments for the RPC call' },
        ...
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              parentPath: { type: 'string', description: 'Parent node path' },
              vertices: { type: 'array', items: { type: 'array', items: { type: 'number' } }, description: 'Vertex positions [[x,y,z],...]' },
              normals: { type: 'array', items: { type: 'array', items: { type: 'number' } }, description: 'Vertex normals [[x,y,z],...]' },
              uvs: { type: 'array', items: { type: 'array', items: { type: 'number' } }, description: 'UV coordinates [[u,v],...]' },
